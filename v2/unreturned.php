...
<head>
    ...
    <title>Unreturned Devices</title>
...
<body>
    ...
    <div class="table-container">
        <div class="table-body">
            ...
            // Retrieve data from the tracking_register table where Returned Date is '0000-00-00'
            $sql = "SELECT
            Id,
            Name, 
            Device_type, 
        ...
        FROM tracking_register WHERE `Return_date` = '0000-00-00'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "No unreturned devices found";
            }
